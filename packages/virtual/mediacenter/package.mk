...
if [ "${MEDIACENTER}" = "kodi" ]; then
  ...
  PKG_DEPENDS_TARGET+=" game.libretro.beetle-bsnes"
  ...
  PKG_DEPENDS_TARGET+=" game.libretro.beetle-saturn"
  ...
  PKG_DEPENDS_TARGET+=" game.libretro.bsnes-mercury-performance"
  ...
  PKG_DEPENDS_TARGET+=" game.libretro.mupen64plus-nx"
